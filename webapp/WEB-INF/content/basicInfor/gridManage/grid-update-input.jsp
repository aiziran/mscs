...
<script type="text/javascript" language="javascript">
	...
	function fncUpd(){
		actSubmitValidate($('#formPage'), 'grid!update.action');
	}
	function fncSave(){
		...
		<form id="formPage" method="post" >
				<div id="resultDiv"	style="width: 800px;"">
					<table class="LDetailArea" id="listTab" style="width:800px">
								...
								<tr><td colspan="2"><h1 align="center">修改格子</h1></td></tr>
										<tr>
										<th ><font color="red">*</font>档案室名称：</th>
										<td  >
										<input type="text" id="archivesname" name="archivesname" value=${archivesname} readonly>
									...
									<tr>
										...
										<input type="text" id="archivesnum" name="archivesnum" value=${archivesnum} readonly>
										</td>
									</tr>
									<tr>
										<th><font color="red">*</font>柜子编号:</th>
										<td nowrap="nowrap">
										<input type="text" id="cabinetnum" name="cabinetnum" value=${cabinetnum} readonly>
									...
									<tr>
										<th>格子编号:</th>
										<td nowrap="nowrap"><input type="text" id="gridnum" name="gridnum" value=${gridnum}></td>
									</tr>
									<tr>
										<th>备注:</th>
										<td nowrap="nowrap">
										<input type="hidden" name="gridid" id="gridid" value=${gridid} }/>
										<textarea id="remark" name="remark" rows="3" style="font-size:15px" style="width:500px" >${remark}</textarea>
										</td>
									</tr>
									</s:iterator>
				...
				<ul class="LbtnArea" >
					...
					<li>
						<input type="button" value="修改" onclick="fncUpd()" id="da" />
					</li>
				</ul>
			</fieldset>
							</div>
