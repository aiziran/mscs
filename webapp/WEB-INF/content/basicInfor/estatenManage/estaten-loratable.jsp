...
<script type="text/javascript" language="javascript">
 	//进入添加页面
	function fncAdd() {
		actSubmit($('#formPage'),'<c:url value="/basicInfor/estatenManage/estaten!loracreate.action"/>');
   }
	//进入修改页面
	function fncDetail(obj) {
		$('#id').val(obj);
		actSubmit($('#formPage'),
				'<c:url value="estaten!loradetail.action"/>');
	}
	...
	function fncFixupListHead() {
		...
		if(str!=this.location.href){
			actSubmit($('#formPage'),'<c:url value="/basicInfor/estatenManage/estaten!loreList.action"/>');
		}
	}
</script>
</head>
