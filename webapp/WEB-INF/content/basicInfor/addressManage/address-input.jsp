...
<script type="text/javascript" language="javascript">
	...
	function fncInp()
	{
		...
		actSubmit($('#formDetail'), '<c:url value="/basicInfor/addressManage/address!input.action"/>');
	}
	//取消当前编辑
	function fncCancel() {
		...
		fncExtraFormCancel('<c:url value="/basicInfor/addressManage/address.action"/>');
	}
	...
	<div id="Lcontent">
		...
		<form id="formDetail" method="post" >
						<table  id="listTab" style="width: 1000px;">			
  								<tr>
									<th colspan="4"><b>公共通讯录添加</b></th>
								</tr>
								<tr>
										<th><font color="red">*</font>姓名</th>
										<td nowrap="nowrap"><input type="text" id="name" name="name"  /></td>
