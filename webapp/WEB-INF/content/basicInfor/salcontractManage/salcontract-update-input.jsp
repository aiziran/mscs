...
<script type="text/javascript" language="javascript">
	...
	function fncSave() {
		...
		actSubmitValidate($('#formDetail'),
				'<c:url value="/basicInfor/salcontractManage/salcontract!doUpdate.action"/>');
	}
	...
	function BrowseUpload(){
		actSubmit($('#formDetail'),
				'<c:url value="/basicInfor/salcontractManage/salcontract!downupload.action"/>');
	}
	function BrowseScan(){
		actSubmit($('#formDetail'),
				'<c:url value="/basicInfor/salcontractManage/salcontract!BrowseScan.action"/>');
	}
</script>
</head>
<body>
	<div id="Lcontent">
		...
		<input type="hidden" name="archivesid" id="archivesid" value="${ updateData.archives}"/>
			<input type="hidden" name="cabinetid" id="cabinetid" value="${ updateData.cabinet}"/>
			<input type="hidden" name="gridid" id="gridid" value="${ updateData.grid}"/>
			...
			<table class="LDetailArea" summary="Inventory information.">
				<tr>
					...
					<td><input type="text" name="area" id="area"
						maxlength="150" value="${updateData.area }"></td>
						
					
					<th><font color="red">*</font>签订日期:</th>
						<td>
										<input type="hidden" id="signedtimevalidity" name="signedtimevalidity" >
										<input type="text" name="signedtime" id="signedtime" class="Wdate"
								onclick="WdatePicker()" readonly="readonly" 
								style="margin-right: 0px;"  value="${updateData.signedtime }">&nbsp;&nbsp;日
										<input type="text" id="signedtimeethours" name="signedtimeethours" style="width:30px" value="${updateData.signedtimeethours}">&nbsp;&nbsp;时
										<input type="text" id="signedtimeminutes" name="ssignedtimeminutes" style="width:30px"  value="${updateData.ssignedtimeminutes}">&nbsp;&nbsp;分
										</td>
				</tr>
				<tr>
					<th><font color="red">*</font>房款:</th>
					<td><input type="text" name="money" id="money" maxlength="150"
						class="Lbordercolor" value="${updateData.money }"></td>
						<th><font color="red">*</font>办理时间:</th>
						<td>
										<input type="hidden" id="handletimevalidity" name="handletimevalidity" >
										<input type="text" name="handletime" id="handletime" class="Wdate"
								onclick="WdatePicker()" readonly="readonly" value="${updateData.handletime}" 
								style="margin-right: 0px;" >&nbsp;&nbsp;日
										<input type="text" id="handletimeethours" name="handletimeethours" style="width:30px" value="${updateData.handletimeethours}" >&nbsp;&nbsp;时
										<input type="text" id="handletimeetminutes" name="handletimeetminutes" style="width:30px" value="${updateData.handletimeetminutes}" >&nbsp;&nbsp;分
										</td>
				...
				<tr>
					...
					<td><input type="text" name="contractnum" id="contractnum"
						maxlength="150" class="Lbordercolor" value="${updateData.contractnum }"></td>
					...
					<td><select name="hname" id="hname">
					        <s:iterator value="contactpeople" var="list">
								...
								<c:if test="${updateData.hname == list.hname}">selected</c:if>>
				...
				<tr>
					...
					<td><input type="text" name="contactphone" id="contactphone"
						maxlength="150" class="Lbordercolor" value="${updateData.contactphone }"></td>
				...
				<tr>
					...
					<td><input type="text" name="address" id="address"
						maxlength="150" class="Lbordercolor" value="${updateData.address }"></td>
						 <th><font color="red">*</font>存档位置:</th>
					<td>
						<input type="text" size="5" id="archivesname" name="archivesname" onclick="javascript:showChildWindow2();" readonly value="${updateData.archivesid }">
						<input type="text" size="5" id="cabinetname" name="cabinetname" onclick="javascript:showChildWindow3();" readonly value="${updateData.cabinetid }">
						<input type="text" size="5" id="gridname" name="gridname" onclick="javascript:showChildWindow4();" readonly value="${updateData.gridid}">
					</td>
				...
				<tr>
					...
					<td><input type="text" name="contractname" id="contractname"
						maxlength="150" class="Lbordercolor" value="${updateData.contractname}"></td>
					<th><font color="red">*</font>合同金额:</th>
					<td><input type="text" name="contractamount" id="contractamount" maxlength="150"
						class="Lbordercolor"  value="${updateData.contractamount }"/></td>
				</tr>
				...
				<tr>
					...
					<td   align="left"><input type="text" name="contractdept" id="contractdept" maxlength="150"
						class="Lbordercolor" value="${updateData.contractdept }"/></td>
						<th><font color="red">*</font>续约时间:</th>
						<td>
										<input type="hidden" id="renewaltimevalidity" name="renewaltimevalidity" >
										<input type="text" name="renewaltime" id="renewaltime" class="Wdate"
								onclick="WdatePicker()" readonly="readonly" value="${updateData.renewaltime}" 
								style="margin-right: 0px;" >&nbsp;&nbsp;日
										<input type="text" id="renewaltimeethours" name="renewaltimeethours" style="width:30px" value="${updateData.renewaltimeethours}" >&nbsp;&nbsp;时
										<input type="text" id="renewaltimeetminutes" name="renewaltimeetminutes" style="width:30px" value="${updateData.renewaltimeetminutes}" >&nbsp;&nbsp;分
										</td>
				</tr>
				<tr>
					<th><font color="red">*</font>合同期限:</th>
					<td colspan="3"><input type="text" name="totalTime" id="totalTime"
						maxlength="150" class="Lbordercolor" value="${ updateData.totalTime}"></td>
					 
				</tr>
				 <tr>
					<th>合同扫描件:</th>
					<td ><a href="#" onclick="BrowseScan()">${updateData.scanFileName }</a></td>
						<th>修改扫描件:</th>
					<td ><input type="file" name="scan" id="scan"
						size="40">
						<input type="hidden" name="annex" id="annex" value="${updateData.annex }">
						</td>
						
				</tr>
				  <tr>
					<th>合同附件:</th>
					<td ><a href="#" onclick="BrowseUpload()">${updateData.uploadFileName }</a></td>
						<th>修改附件:</th>
					<td ><input type="file" name="upload" id="upload"
						size="40">
						<input type="hidden" name="access" id="access" value="${updateData.access }"></td>
