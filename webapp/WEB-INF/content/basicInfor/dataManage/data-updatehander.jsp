...
<script type="text/javascript" language="javascript">
	...
	//取消当前编辑
  	...
  	//保存操作
  	function fncSave() { 
  		actSubmitValidate($('#formDetail'), '<c:url value="/basicInfor/dataManage/data!updateHander.action"/>');
  	}
  	...
  	<form id="formDetail" method="post">
  		...
  		<table class="LDetailArea" summary="dataInfo information.">
				...
				<tr>
      			<th><span> 姓名</span></th>
      			<td>
					<input type="text" id="name" name="name" size="20" class="Lbordercolor" value="${dataInfo.name}" validate="{required:true,maxlength:50}"/>
				</td>
	            </tr>
	            <tr>
      			<th><span> 年龄</span></th>
