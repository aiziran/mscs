...
<script type="text/javascript" language="javascript">
	...
	//取消当前编辑
  	...
  	//保存操作
  	function fncSave() { 
  		actSubmitValidate($('#formDetail'), '<c:url value="/basicInfor/dataManage/data!updateTeam.action"/>');
  	}
		...
		<input type="hidden" name="id" value="${data.id}"/>
  		<table class="LDetailArea" summary="dataInfo information.">
    		<tr>
      			<th><span> 班组</span></th>
      			<td>
					<input type="text" id="teamname" name="teamname" size="20" class="Lbordercolor" value="${dataInfo.teamname}" validate="{required:true,maxlength:50}"/>
				</td>
	      </tr>
