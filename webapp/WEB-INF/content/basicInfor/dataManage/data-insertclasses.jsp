...
<script type="text/javascript" language="javascript">
	...
	//取消当前编辑
  	...
  	//保存操作
  	function fncSave() { 
  		actSubmitValidate($('#formDetail'), '<c:url value="/basicInfor/dataManage/data!insertClasses.action"/>');
  	}
	...
	<!-- <pbf:navigation/> -->
  	<form id="formDetail" method="post">
  		...
  		<table class="LDetailArea" summary="Dept information.">
    		<tr>
      			<th><font color="red">*</font><span> 班次名称</span></th>
      			<td>
					<input type="text" id="classesname" name="classesname" size="20" class="Lbordercolor" value="" validate="{required:true,maxlength:50}"/>
				</td>
