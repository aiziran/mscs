	...
	<div id="Lcontent">
		...
		<form id="formPage" method="post" action="../emailManage/email!createEmailResult.action" enctype="multipart/form-data">
		     	<table class="LlistArea"  id="listTab">
					 <tr  >
					  <th align="left" colspan="2"> &nbsp;<input style="width:60px;" class="button" type="button" value="发&nbsp;&nbsp;送" onClick="fncInp()"/> </th>
					 </tr>
					 <tr>
					...
					<tr>
					  <th> 插入:  </th>
					<td><div style="float:left;padding-left:35px;">附件： <input style="width: 300px;height:20px" type="file" value="上传" name="upload" id="upload"></div></td>
					</tr>
