...
<script type="text/javascript" language="javascript">
	...
	function fncSubmit() {
		   	actSubmit($('#formSearch'), '<c:url value="/basicInfor/userManage/user!handerDetail.action"/>');
  	}
</script>
</head>
<body class="body_sub">	
	<div id ="groupSupply" style="position:absolute; background-color:#ffffff;width:500px;display:block">
		...
		<form id="formPage" method="post" action="/basicInfor/userManage/user!handerDetail.action">								
