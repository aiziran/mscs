...
<script type="text/javascript" language="javascript">
	...
	//取消当前编辑
  	function fncCancel() {
    	...
    	fncExtraFormCancel('<c:url value="/basicInfor/userManage/user!behand.action"/>');
  	}
  	...
  	function fncSave() { 
		...
		if(a!=""){
  		...
  		actSubmitValidate($('#formDetail'), 
  				'<c:url value="/basicInfor/userManage/user!saveBehand.action"/>');
  	}
  ...
  function setSelect(hid,sid)
  {
	...
	//删除前验证是否有库存录入
  	...
  	function fncDelete() {
    	...
    	actSubmitValidate($('#formDetail'), 
    			'<c:url value="/basicInfor/userManage/user!deleteBehand.action"/>');
  	}
