...
<script type="text/javascript" language="javascript">
	...
	function fncDetail(obj) {
		...
		actSubmit($('#formPage'),
				'<c:url value="/basicInfor/userManage/user!updateBehand.action"/>');
	}

	//进入新增页面
	function fncAdd() {
		actSubmit($('#formPage'),
				'<c:url value="/basicInfor/userManage/user!createBehand.action"/>');
	}
	...
	function showChildWindow1() {
		...
		var url = "<c:url value='/basicInfor/userManage/user!behandDetail.action'/>";
	...
	<div id="Lcontent">
		...
		<div id="LsearchArea">
			<form id="formSearch" name="formSearch" method="post"
				...
				action="<c:url value="/basicInfor/userManage/user!behand.action"/>"
				onEnter="this.submit()">
