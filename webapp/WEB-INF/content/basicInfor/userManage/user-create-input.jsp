...
<script type="text/javascript" language="javascript">
	...
	function fncSave() {
		...
		if(newPwdVal===null || newPwdVal.trim().length<=0) {
			alert("密码不能为空");
			return ;
		}
...
// 	    xmlHttp.send( null );
		actSubmitValidate($('#formDetail'), '<c:url value="/basicInfor/userManage/user!save.action"/>');
	}
	...
	<div id="Lcontent">
		...
		<fieldset>
			...
			<ul class="LbtnArea">
				...
				<input type="button" value="保存" onclick="fncSave()"
