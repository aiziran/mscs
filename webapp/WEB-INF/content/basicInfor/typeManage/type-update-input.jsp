...
<script type="text/javascript" language="javascript">
	...
	function fncInp(){
		...
		actSubmit($('#formPage'), '<c:url value="/basicInfor/typeManage/type!update.action"/>');
	}
</script>
</head>
					...
					<table class="LlistArea" id="listTab" style="width: 1000px;">
						...
						<c:if test="${empty page.result}">
							<table class="LlistArea" id="listTab">
									...
									<tr>
										<td colspan="2"><b>修改档案类型</b></td>
									</tr>
									<tr>
										<td ><b>档案类型编号</b></td>
										<td name="tid">${test.id} </td>
									</tr>
									<tr>
										<td><font color="red">*</font>档案室类型名称</td>
										<td nowrap="nowrap"><input type="text" id="archivename" name="archivename" value="${test.archivename}"></td>
									</tr>
									<tr><td nowrap="nowrap"><input type="hidden" name="tid"  value="${test.id}"/></td>
									<td nowrap="nowrap"><input type="button" value="提交" onclick="fncInp()" />&nbsp;</td></tr>
