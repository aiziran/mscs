...
<table id="pageTb" border="0" cellspacing="0" cellpadding="0" align="center" style="display:none">
</c:if>
<c:if test="${!empty page.result}">
<table id="pageTb" border="0" cellspacing="0" cellpadding="0" align="center" >
</c:if>
  	<tr align="left">
		<td align="center" style="border:0;width:20%;text-align:center">
			...
			<!-- 页面选择图标，向后选择 -->
		      ...
		      <c:if test="${page.pageNo!=1}">
		     	<a href="#" onclick="goPage('1'); return false;"><IMG border = 0 src='${ctx}/images/btn_pag_dfront.jpg'></a>
		      	<a href="#" onclick="goPage('${page.pageNo-1}'); return false;"><IMG border = 0 src='${ctx}/images/btn_pag_dprev.jpg'></a>
		      </c:if>
		      <!-- 页面数字选择 -->
		      ...
		      <c:if test="${pageNum!=page.pageNo}">
		     	<a href="#" onclick="goPage('${page.pageNo+1}'); return false;"><IMG border = 0 src='${ctx}/images/btn_pag_next.jpg'></a>
		      	<a href="#" onclick="goPage('${pageNum}'); return false;"><IMG border = 0 src='${ctx}/images/btn_pag_dlast.jpg'></a>
		      </c:if>	
		   <%
...
<script type="text/javascript" language="javascript">				
				...
				function pagePost(action) {
					$("#formPage").action = action;
					$("#formPage").submit();
				}
	            $("#pageTb").css("width",$("#formPage").width()-10);
