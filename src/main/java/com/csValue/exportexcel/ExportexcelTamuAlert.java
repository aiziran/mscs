...
public class ExportexcelTamuAlert
{
    ...
    throws Exception
  {
    ...
    workbook.setSheetName(0, "TAMU机手修改历史");
    workbook.setSheetName(1, "TAMU质检修改历史");
    ...
    try
    {
      System.out.println("TAMU修改历史.xls");
      HttpServletResponse resp = Struts2Utils.getResponse();
      resp.setCharacterEncoding("UTF-8");
      resp.setContentType("text/html;charset=utf-8");
      resp.setContentType("application/x-download");
      resp.addHeader("Content-Disposition", "attachment;filename=" + URLEncoder.encode("TAMU修改历史.xls", "UTF-8"));
